...
router.post('/', requireAuth, (req, res) => {
  const {
    ...
    target_muscle_groups, intensity_level, activity_level, days_per_week, equipment, calorie_goal, cuisine_preferences, measurement_unit
  } = req.body;

  const allowedActivityLevels = ['sedentary', 'lightly_active', 'moderately_active', 'active', 'very_active'];
  ...
  const data = {
    ...
    activity_level: allowedActivityLevels.includes(activity_level) ? activity_level : 'sedentary',
